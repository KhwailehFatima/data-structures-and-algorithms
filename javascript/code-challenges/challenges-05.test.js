...
const addValues = (arr) => {
  // Solution code here...
  let sum=arr.reduce((currentSum,currentValue)=>{
...
const addPurchases = (arr) => {
  // Solution code here...
let sum=arr.reduce((currentSum,currentValue)=>{
  return currentSum+currentValue.purchasePrice;
},0)
return sum
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let sum =arr.reduce ((previousValue)=>{
...
const reversedString = (str) => {
  let reversed = str.split('').reduce((previousValue, currentValue) => {
